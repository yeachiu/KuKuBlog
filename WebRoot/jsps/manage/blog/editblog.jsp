...
<body>
	...
	<div class="container">
		<div class="panel-body panel-default writeblog">
			...
			<form class="form-horizontal" action="BlogServlet" method="post" id="eblogForm">
				<input type="hidden" id="target" method="addBlog"> 
				<input type="hidden" name="blogId" value="${blog.blogId }">	
				<div class="form-group input-group-lg">
				  <input type="text" class="form-control" placeholder="输入文章标题" id="blogTitle" name="blogTitle" value="${blog.blogTitle}"/>
				</div>
				...
				<div class="settag">
					...
					<div class="blogtags" id="blogtags">
				  	...
				  	<div class="tijiao">
					<input class="btn btn-primary btn-lg " id="tijiao1"  type="button" value="保存修改">
					</div>
				</div> 	
			</form>
		</div>
    ...
    function  tijiao()	{
		$("#eblogForm").removeAttr("action");
		$("#eblogForm").attr("action","<c:url value='/MBlogServlet?method=updateBlog'/>");
		$("#eblogForm").submit();
	}
	function  savedraft() {
